...
print("======================================================")
print("  完全ハイブリッド量子AI - [アイリス実データ：150Epoch限界突破テスト]")
print("======================================================\n")
...
class IrisQuantumClassifier:
    ...
    def fit(self, train_data, epochs=150, log_interval=15):
        ...
        print("=== [Phase 2] アイリス実データ 長期メイン学習フェーズ（150Epoch） ===")
...
if __name__ == "__main__":
    ...
    train_data = formatted_data[:120]
    test_data = formatted_data[120:]

    # 【変更】Epoch数を150に、log_intervalを15に拡張
    classifier = IrisQuantumClassifier(n_qubits=4, num_layers=4)
