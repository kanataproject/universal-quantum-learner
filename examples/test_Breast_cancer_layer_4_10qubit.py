...
def run_control_panel(X_train, y_train, X_test, y_test, step_candidates, initial_weights, log_interval, shared_dict, timestamp):
    ...
    pygame.display.set_caption("30D Cancer Data (10Qubit/16Nodes) Final Test")
    ...
    while running:
        ...
        if ui_state == "SETUP":
            title = font_xl.render("10-QUBIT / 16-NODE FINAL TEST", True, TEXT_COLOR)
            ...
            start_txt = font_xl.render("LAUNCH FINAL HUNT", True, (255, 255, 255))
            ...
            title = font_l.render("10Qubit Final Hunter Dashboard", True, (190, 180, 180))
            ...
            for step in step_candidates:
                ...
                info_text2 = font_s.render(f"Stagnation: {stag}/2", True, COLOR_KILL_STAG if stag > 0 else (160, 150, 150))
            ...
            if active_processes == 0 and len(shared_dict) == len(step_candidates):
                footer_txt = "All lanes finished hunting! Ready for Refactoring."
...
if __name__ == "__main__":
    ...
    step_candidates = [0.1, 0.01, 0.001, 0.0001, 0.00001, 0.000001]
    ...
    print("\n[INFO] 30次元 Breast Cancer (10Qubit / 16ノード 最終検証版) を起動します...")
